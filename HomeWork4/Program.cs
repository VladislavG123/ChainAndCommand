...
namespace HomeWork4
{
    ...
    class CatHandler : AbstractHandler
    {
        public override object Handle(object request)
        {
            ...
            {
                return $"Cat: I'll drink the {request.ToString()}.\n";
            }
            else
            {
                return base.Handle(request);
    ...
    class Client
    {
        ...
        {
            foreach (var food in new List<string> { "Nut", "Banana", "Milk", "Cup of coffee" })
            {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            monkey.SetNext(squirrel).SetNext(cat).SetNext(dog);
